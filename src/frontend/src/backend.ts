...
export class Backend implements backendInterface {
    ...
    async authenticate(arg0: string, arg1: string): Promise<UserProfile | null> {
        if (this.processError) {
            try {
    ...
    async getAllRegistrationsSorted(): Promise<Array<Registration>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRegistrationsSorted();
    ...
    async initializeActorAdmin(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeActorAdmin();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async register(arg0: string, arg1: string, arg2: UserRole): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.register(arg0, arg1, to_candid_UserRole_n1(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Registration_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Registration): Registration {
...
function from_candid_vec_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Registration>): Array<Registration> {
    return value.map((x)=>from_candid_Registration_n10(_uploadFile, _downloadFile, x));
}
